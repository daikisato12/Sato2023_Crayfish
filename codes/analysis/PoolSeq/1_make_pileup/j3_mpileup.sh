...
samtools mpileup -C50 -q20 -Q20 -f ${REF} ${FILELIST} > ./mpileup/${POOLNAME}.pileup
...
bcftools mpileup -Ou -f ${REF} ${FILELIST} -C 50 -q 20 -Q 20 | bcftools call -vmO z -o ./mpileup/${POOLNAME}.vcf.gz
