...
cat ${SAMPLE}.consensus.psmc ./bootstrap/${SAMPLE}.filtered.{1..100}.bs.psmc > ./bs_results/${SAMPLE}.filtered.combined.psmc
perl /codes/software/utils/psmc_plot.pl -X50000000 -p -g1 -R -x1000 -u4.59e-09 ./bs_results/${SAMPLE}.results ./bs_results/${SAMPLE}.filtered.combined.psmc
